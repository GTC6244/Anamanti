...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1631658749;
...
fn wire__crate__api__settings__get_drive_token_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::api::settings::get_drive_token(
                            api_orchestrator_key,
                            api_discovery_timeout_secs,
                        )?;
                        Ok(output_ok)
...
fn wire__crate__api__engine__start_notify_channel_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "start_notify_channel",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_config = <crate::api::engine::NotifyConfig>::sse_decode(&mut deserializer);
            let api_sink = <StreamSink<
                crate::api::engine::NotifyEvent,
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok =
                            crate::api::engine::start_notify_channel(api_config, api_sink)?;
                        Ok(output_ok)
                    })(),
                )
            }
...
fn wire__crate__api__engine__stop_notify_channel_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "stop_notify_channel",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::engine::stop_notify_channel();
                    })?;
                    Ok(output_ok)
                })())
            }
...
impl SseDecode for crate::api::settings::DriveToken {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
...
impl SseDecode for crate::api::engine::NotifyEvent {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_id = <String>::sse_decode(deserializer);
        ...
        return crate::api::engine::NotifyEvent {
            id: var_id,
...
impl SseDecode for crate::api::engine::WakeWordEventKind {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        return match inner {
            ...
            10 => crate::api::engine::WakeWordEventKind::ListeningFollowup,
            11 => crate::api::engine::WakeWordEventKind::Disconnected,
            12 => crate::api::engine::WakeWordEventKind::Stopped,
            13 => crate::api::engine::WakeWordEventKind::Error,
            ...
            19 => crate::api::engine::WakeWordEventKind::RecipeNavigate,
            20 => crate::api::engine::WakeWordEventKind::RecipeScroll,
            21 => crate::api::engine::WakeWordEventKind::Presence,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        23 => wire__crate__api__settings__update_orchestrator_settings_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
impl flutter_rust_bridge::IntoDart for crate::api::settings::DriveToken {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            ...
            self.folder_ids.into_into_dart().into_dart(),
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::settings::DriveToken
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::settings::DriveToken>
    for crate::api::settings::DriveToken
{
    fn into_into_dart(self) -> crate::api::settings::DriveToken {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::engine::NotifyConfig {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::engine::NotifyConfig
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::engine::NotifyConfig>
    for crate::api::engine::NotifyConfig
{
    fn into_into_dart(self) -> crate::api::engine::NotifyConfig {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::engine::NotifyEvent {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            self.id.into_into_dart().into_dart(),
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::engine::NotifyEvent
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::engine::NotifyEvent>
    for crate::api::engine::NotifyEvent
{
    fn into_into_dart(self) -> crate::api::engine::NotifyEvent {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl flutter_rust_bridge::IntoDart for crate::api::engine::WakeWordEventKind {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            ...
            Self::ListeningFollowup => 10.into_dart(),
            Self::Disconnected => 11.into_dart(),
            Self::Stopped => 12.into_dart(),
            Self::Error => 13.into_dart(),
            ...
            Self::RecipeNavigate => 19.into_dart(),
            Self::RecipeScroll => 20.into_dart(),
            Self::Presence => 21.into_dart(),
            _ => unreachable!(),
        }
    }
}
...
impl SseEncode for crate::api::settings::DriveToken {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        ...
        <String>::sse_encode(self.client_secret, serializer);
        <String>::sse_encode(self.refresh_token, serializer);
        <Vec<String>>::sse_encode(self.folder_ids, serializer);
...
impl SseEncode for crate::api::engine::NotifyEvent {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <String>::sse_encode(self.id, serializer);
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(
            match self {
                ...
                crate::api::engine::WakeWordEventKind::ListeningFollowup => 10,
                crate::api::engine::WakeWordEventKind::Disconnected => 11,
                crate::api::engine::WakeWordEventKind::Stopped => 12,
                crate::api::engine::WakeWordEventKind::Error => 13,
                ...
                crate::api::engine::WakeWordEventKind::RecipeNavigate => 19,
                crate::api::engine::WakeWordEventKind::RecipeScroll => 20,
                crate::api::engine::WakeWordEventKind::Presence => 21,
                _ => {
                    unimplemented!("");
                }
            },
