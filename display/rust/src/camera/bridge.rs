...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_ambientdisplay_ambient_1display_CameraBridge_nativeCacheClass<
    'local,
>(
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_ambientdisplay_ambient_1display_CameraBridge_nativePushLuma<
    'local,
>(
    mut env: jni::EnvUnowned<'local>,
