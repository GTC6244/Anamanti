...
fn main() {
    ...
    println!("cargo:rustc-env=AMBIENT_GIT_SHA={sha}{dirty}");
    println!("cargo:rustc-env=AMBIENT_GIT_BRANCH={branch}");
    println!("cargo:rustc-env=AMBIENT_BUILD_TIME={build_time}");
