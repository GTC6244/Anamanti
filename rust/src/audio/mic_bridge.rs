...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_ambientdisplay_ambient_1display_MicBridge_nativeCacheClass<'local>(
...
/// callback's `try_push`).
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_ambientdisplay_ambient_1display_MicBridge_nativePush<'local>(
    mut env: jni::EnvUnowned<'local>,
